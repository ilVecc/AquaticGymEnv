...
if __name__ == '__main__':
    ...
    if not os.path.exists("model.json"):
        # 3 input per stato (x_boat,y_boat,angle_boat)
        # 100 output (una per azione)
        neural_network = create_model(3, n_actions, 32, 5)
        neural_network, score = DQN(env, actions, neural_network, trials=100, max_iter=1000)
