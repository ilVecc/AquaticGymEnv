...
def plot_network_qvalue(path, goal_state, world_size, sectors=8):
    ...
    model = tf.keras.models.load_model(str(Path(path) / "model"))
...
if __name__ == "__main__":
    ...
    policy_path = "dqn_no_obs/policy_name/models/model-00000"
    goal = np.array([[50, 50]])
    
    plot_network_qvalue(policy_path, goal_state=goal, world_size=100)
